...
process.stdout.write(JSON.stringify({ mode: live ? 'live-read-only' : 'anonymized', initialization: 'passed', toolCount: 7, accountContext: 'passed', accessibleGymCount: gymCount, explicitSelection: 'passed', inaccessibleSelection: 'rejected', sanitizedErrors: 'passed', serverStderr: 'empty' }) + '\n');
