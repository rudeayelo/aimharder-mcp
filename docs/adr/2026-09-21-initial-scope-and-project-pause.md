...
The project explores integrating AimHarder to query schedules, personal bookings, personal records, and WODs. The user requested that work remain limited to documentation while the product scope was being defined.

## Decision

Pause ongoing implementation. Document decisions in `docs/adr/` using `YYYY-MM-DD-[title].md` filenames. Do not build a UI, deploy services, create automation, or make bookings at this stage.
